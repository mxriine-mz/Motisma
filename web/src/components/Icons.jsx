// Lightweight line icons (currentColor), used in place of emoji.
const BASE = {
  fill: 'none',
  stroke: 'currentColor',
  strokeWidth: 2,
...
export default function Icon({ name, size = 24 }) {
  const props = { width: size, height: size, viewBox: '0 0 24 24', 'aria-hidden': true, ...BASE };
  switch (name) {
    case 'map':
      return (
        <svg {...props}>
    ...
    case 'megaphone':
      return (
        <svg {...props}>
          ...
          <path d="M3 11v2a2 2 0 0 0 2 2h1V9H5a2 2 0 0 0-2 2z" />
    ...
    case 'medal':
      return (
        <svg {...props}>
          ...
          <path d="M8.5 8.5 6 2h4l2 4 2-4h4l-2.5 6.5" />
        </svg>
      );
    case 'gear':
      return (
    ...
    case 'scroll':
      return (
        <svg {...props}>
          <path d="M8 3H6a2 2 0 0 0-2 2v12a3 3 0 0 0 3 3h11a2 2 0 0 0 2-2v-1H9" />
